(function (root, factory) {
  ...
  function migrateShift(shift) {
    ...
    // 0.063：00前回倉獨立保存，不混入00後30分鐘 returnEvents。
  ...
  function makeReturnReportText(shift) {
    ...
    // 0.063：上半部只列出00後實際有回倉紀錄的來源；0不列出。
    ...
    // 0.063：完整回倉總數比照03:00快速回報，使用全形固定欄寬表格對齊。
    ...
    const returnSummarySources = [...fixedReturnSummarySources, ...lowerUnknownSources];
